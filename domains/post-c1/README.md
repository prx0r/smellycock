...
Reference is the code at `/root/fuck-off/scripts/` + the registries at `/root/patalacheckpoints/`
...
*This is a projection of the real build at `/root/fuck-off/scripts/` + `/root/patalacheckpoints/`. Run
